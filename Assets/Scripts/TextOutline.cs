...
public class TextOutline : MonoBehaviour
{
    ...
    Vector3 GetOffset(int i)
    {
        ...
        switch (i % 8)
        {
            case 0: return new Vector3(0, 1, offset);
            case 1: return new Vector3(1, 1, offset);
            case 2: return new Vector3(1, 0, offset);
            case 3: return new Vector3(1, -1, offset);
            case 4: return new Vector3(0, -1, offset);
            case 5: return new Vector3(-1, -1, offset);
            case 6: return new Vector3(-1, 0, offset);
            case 7: return new Vector3(-1, 1, offset);
